...
docker run -e DS_LICENSE=accept -e LISTEN_ADDRESS=127.0.0.1 -e START_RPC=true --net=host --name dse -d -p 8182:8182 -p 9042:9042 -p 61621:61621 datastax/dse-server:5.1.6 -g

# start dse-studio (not needed for tests)
docker run -e DS_LICENSE=accept --name dse-studio -d -p 9091:9091 --net=host kabirkbr/dse-studio:working
