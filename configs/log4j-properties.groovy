...
log4j.appender."SIM.layout.ConversionPattern"= "%d{yyyy-mm-dd'T'HH:mm:ss.SSS} [%t] %-5p %c %x : %m%n"
...
log4j.appender."DB.layout.ConversionPattern"= "%d{yyyy-mm-dd'T'HH:mm:ss.SSS} [%t] %-5p %c %x : %m%n"
...
log4j.appender."TR.layout.ConversionPattern"= "%d{yyyy-mm-dd'T'HH:mm:ss.SSS} [%t] %-5p %c %x : %m%n"
