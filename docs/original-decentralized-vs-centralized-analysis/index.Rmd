...
for (experimentId in selectedExperiments) {
  ...
  simulations.df <- simulations.df[which(simulations.df$simulationId != "SIM08-02-01-31-R9x4ai--DV" & simulations.df$simulationId != "SIM08-09-03-24-FsJcdE--DV" & simulations.df$simulationId != "SIM08-10-06-29-jKDYmz--CV" & simulations.df$simulationId != "SIM08-11-04-26-tNxY4J--DV"), ]
