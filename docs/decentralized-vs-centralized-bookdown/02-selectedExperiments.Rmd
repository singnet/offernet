...
cat(paste('# Summary of all selected experiments \n\n'))
...
scatterplot <- function(data, xstr,ystr, sizestr, colorstr, titlelab, ylab,xlab) {
  gg <- ggplot(data, aes_string(x=xstr, y=ystr)) + 
...
scatterplot(summary.df,
            'agentNumber',
            'sum_wallTime_min_total',
            'foundCycles',
            'simulationType',
            "agentNumber vs systemTime",
            "total system time (min)",
            "agent number")
