...
cat(paste('  \n\n'))
cat(paste('# Cross analysis of all selected experiments\n\n'))
...
ys <- c('sum_wallTime_min_total')
colors <- c('simulationType_chainLength','simulationType_similaritySearchThreshold','simulationType_similarityConnectThreshold','simulationType_maxDistance')
used <- append(ys,colors)
sizes <- c('foundCycles')
used <- append(used,sizes)
