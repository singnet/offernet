...
selectedExperiments <- c('EXP10-02-01-04-YQvrhC','EXP10-03-10-34-Lfip5F','EXP10-03-11-06-mTThJr', 'EXP10-04-01-28-KKABTK', 'EXP10-04-11-00-6NwhDL', 'EXP10-05-01-29-BHt6a5','EXP10-05-10-28-Z7PYyS')
descriptions <- c('agentNumbers=[400] : chainLengths=[10, 20] : randomWorksNumberMultipliers=[1, 2] : maxDistances=[5, 10, 30] : similaritySearchThresholds=[1] : similarityConnectThresholds=[0.9] : graphTypes=[random, smallWorld]; rest of simulations with 400 agents...','agentNumbers=[800] : chainLengths=[5, 10, 20] : randomWorksNumberMultipliers=[1, 2] : maxDistances=[5, 10, 30] : similaritySearchThresholds=[1] : similarityConnectThresholds=[0.9] : graphTypes=[random, smallWorld]; rerunning with 800 agents...','agentNumbers=[800] : chainLengths=[5] : randomWorksNumberMultipliers=[1] : maxDistances=[30] : similaritySearchThresholds=[1] : similarityConnectThresholds=[0.9] : graphTypes=[random, smallWorld]; finishing 800 agent simulations with 1 randomWork after crash...', 'agentNumbers=[800] : chainLengths=[5, 10, 20] : randomWorksNumberMultipliers=[2] : maxDistances=[5, 10, 30] : similaritySearchThresholds=[1] : similarityConnectThresholds=[0.9] : graphTypes=[random, smallWorld] : message=[800 agent simulations with 2 randomWorksNumbers...]', 'agentNumbers=[800] : chainLengths=[5, 10, 20] : randomWorksNumberMultipliers=[2] : maxDistances=[10, 30] : similaritySearchThresholds=[1] : similarityConnectThresholds=[0.9] : graphTypes=[random, smallWorld]; repeating after crash', 'agentNumbers=[800] : chainLengths=[5, 10, 20] : randomWorksNumberMultipliers=[2] : maxDistances=[10, 30] : similaritySearchThresholds=[1] : similarityConnectThresholds=[0.9] : graphTypes=[random, smallWorld]; another crash -- putting what was left, more data should not harm...','gentNumbers=[800] : chainLengths=[5] : randomWorksNumberMultipliers=[2] : maxDistances=[30] : similaritySearchThresholds=[1] : similarityConnectThresholds=[0.9] : graphTypes=[random, smallWorld]; finishing 800 agent simulation with maxDistance=30 and chainLength=5 -- after graph database restart, which stopped the repeated crashing (!)')
```
...
|7 | `r selectedExperiments[6]` | `r descriptions[7]` |
