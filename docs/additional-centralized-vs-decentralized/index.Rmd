...
selectedExperiments <- c('EXP09-04-04-11-kvIbMs','EXP09-04-11-00-zmNPzL','EXP09-04-01-13-AzAjTh')
descriptions <- c('800 agents simulation (repeating crashed one)','Run time dependency on agent number (all other parameters the same)','Run time dependency on edge numbers (all other parameters the same); edge number is modulated by similarityConnectThreshold parameter')
```

|No. | expermentId | Comment |
|:--|:--|:--|
|1 | `r selectedExperiments[3]` | `r descriptions[3]` |
|2 | `r selectedExperiments[2]` | `r descriptions[2]` |
|3 | `r selectedExperiments[1]` | `r descriptions[1]` |
