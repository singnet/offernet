...
Currently the process is implemented by [`Agent.searchAndConnect(...)`](https://github.com/singnet/offernet/blob/30c9d7b5b7fcab5d6fa1cf6bb97c86ccc6cb7c2f/src/main/groovy/Agent.groovy#L367) routine.
...
##### Process#4: Find and connect similar items of exchange via similarity links
