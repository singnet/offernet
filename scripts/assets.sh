...
# Titan
if [ ! -d titan-1.0.0-hadoop1 ]; then if [ ! -f titan-1.0.0-hadoop1.zip ]; then wget "http://s3.thinkaurelius.com/downloads/titan/titan-1.0.0-hadoop1.zip"; fi; unzip titan-1.0.0-hadoop1.zip; mv titan-1.0.0-hadoop1 titan; rm titan-1.0.0-hadoop1.zip; fi
